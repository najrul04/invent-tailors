...
<footer className="bg-gradient-to-b from-blue-100 via-blue-300 to-blue-500 text-base-content rounded-t-lg mt-20">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-500 md:flex md:items-center md:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            ...
            <a href="https://twitter.com/InventTailors" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                <span className="sr-only">Twitter page</span>
            </a>
            <a href="https://www.linkedin.com/company/invent-tailors/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">

                <path d="M21.78,0H2.22A2.22,2.22,0,0,0,0,2.22V21.78A2.22,2.22,0,0,0,2.22,24H21.78a2.22,2.22,0,0,0,2.22-2.22V2.22A2.22,2.22,0,0,0,21.78,0ZM7.76,20.44H4.89V9.53h2.87ZM6.33,8.41a2.19,2.19,0,1,1,2.19-2.19A2.19,2.19,0,0,1,6.33,8.41ZM20.44,20.44h-2.87v-4.5c0-1.08,0-2.47-1.5-2.47s-1.73,1.15-1.73,2.36v4.61H12.93V9.53h2.64v1.26h.04a3,3,0,0,1,2.73-1.5c2.93,0,3.47,1.93,3.47,4.43v5.72Z"clip-rule="evenodd" />
